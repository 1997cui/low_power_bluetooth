...
/**
 ****************************************************************************************
 * @brief  Call the scheduler if the ble module is powered
 * @return void
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief  Turn the radio off according to the current sleep_mode and check if we can go into deep sleep
 * @param[in] current_sleep_mode The current sleep mode proposed by the system so far.
