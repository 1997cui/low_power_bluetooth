...
*/
	RESERVE_GPIO(LED, GPIO_LED_PORT, GPIO_LED_PIN, PID_GPIO);
		...
		RESERVE_GPIO(SPI, SPI_GPIO_PORT, SPI_CS_PIN, PID_SPI_EN);
    RESERVE_GPIO(SPI, SPI_GPIO_PORT, SPI_CLK_PIN, PID_SPI_CLK);
    RESERVE_GPIO(SPI, SPI_GPIO_PORT, SPI_DO_PIN, PID_SPI_DO);
    RESERVE_GPIO(SPI, SPI_GPIO_PORT, SPI_DI_PIN, PID_SPI_DI);
}
